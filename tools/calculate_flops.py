...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="eca_cbam",
        choices=["none", "eca", "cbam", "eca_cbam"],
        help="Attention type (for our_model)",
    )
    ...
    macs, params = profile(
        model, inputs=(dummy_input,), custom_ops=custom_ops, verbose=False
    )
    macs, params = clever_format([macs, params], "%.3f")

    attn_str = (
        f" | Attention: {args.attention_type}"
